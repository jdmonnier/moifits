...
from moifits.oichi2 import setup_nfft, image_to_vis, image_to_obs, chi2_nfft, chi2_fg
from moifits.oioptimize import chi2_sparco_f, chi2_sparco_fg, optimize_sparco_parameters
...
def test_julia_nfft(oifits_file, nx, pixsize):
    ...
    # Setup NFFT
    include("{inference_dir}/tests/julia_reference/oichi2.jl")
...
def compare_results(py_result, jl_result, oifits_file):
    ...
    from moifits.oichi2 import mod360
